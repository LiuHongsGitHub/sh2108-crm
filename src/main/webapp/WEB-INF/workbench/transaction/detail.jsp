...
<script>
	...
	function refresh(index){
		$.get("/crm/workbench/transaction/queryStage", {'id': '${id}', 'index': index}, function (data) {
			//data是map，包含了stageVos对象，和tranHistory对象
			...
			for (var i = 0; i < stageVos.length; i++) {
				...
				if (stageVo.type == "绿圈") {
					$("#stageDiv").append("<span   onclick=\"changeStage(" + i + ")\"   class=\"glyphicon glyphicon-ok-circle mystage\" data-toggle=\"popover\" data-placement=\"bottom\" data-content=" + stageVo.stage + ":" + stageVo.possibility + " style=\"color: #90F790;\"></span>\n");
				} else if (stageVo.type == "锚点") {
					$("#stageDiv").append("<span   onclick=\"changeStage(" + i + ")\" class=\"glyphicon glyphicon-map-marker mystage\" data-toggle=\"popover\" data-placement=\"bottom\" data-content=" + stageVo.stage + ":" + stageVo.possibility + "   style=\"color: #90F790;\"></span>\n");
					//设置页面上可能性的内容
					$("#possibility").text(stageVo.possibility);
					$("#stage").text(stageVo.stage);
				} else if (stageVo.type == "黑圈") {
					$("#stageDiv").append("<span   onclick=\"changeStage(" + i + ")\" class=\"glyphicon glyphicon-record mystage\" data-toggle=\"popover\" data-placement=\"bottom\" data-content=" + stageVo.stage + ":" + stageVo.possibility + "   style=\"color: black;\" ></span>\n");
				} else if (stageVo.type == "红叉") {
					$("#stageDiv").append("<span    onclick=\"changeStage(" + i + ")\" class=\"glyphicon glyphicon-remove mystage\" data-toggle=\"popover\" data-placement=\"bottom\" data-content=" + stageVo.stage + ":" + stageVo.possibility + " style=\"color: red;\"></span>\n");
					//设置页面上可能性的内容
					$("#possibility").text(stageVo.possibility);
					$("#stage").text(stageVo.stage);
				} else if (stageVo.type == "黑叉") {
					$("#stageDiv").append("<span   onclick=\"changeStage(" + i + ")\" class=\"glyphicon glyphicon-remove mystage\" data-toggle=\"popover\" data-placement=\"bottom\" data-content=" + stageVo.stage + ":" + stageVo.possibility + " style=\"color: black;\"></span>\n");
				}
				$("#stageDiv").append("-----------");
			}
